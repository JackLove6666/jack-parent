package com.cloud.jack.app.distributed.mq;

import com.cloud.jack.app.rabbit.RabbitMQService;
...
public class ProducerTest {
    ...
    public void sendFanout() {
        for (int i = 0; i < 50; i++) {
            rabbitMQService.sendMessageByExchange("fanout-exchange", null, "发布与订阅模式的消息！" + i,"发布与订阅模式的消息"+i);
        }
    }
    ...
    public void sendDirect() {
        for (int i = 0; i < 50; i++) {
            ...
            rabbitMQService.sendMessageByExchange("direct-exchange", routingKey, "路由模式的消息，路由routingKey=" + routingKey + "  i=" + i,"路由模式的消息"+i);
        }
    }
    ...
    public void sendTopic() {
        for (int i = 0; i < 50; i++) {
            ...
            rabbitMQService.sendMessageByExchange("topic-exchange", routingKey, "主题模式的消息，路由routingKey=" + routingKey + "  i=" + i,"主题模式的消息"+i);
        }
    }
    ...
    public void sendTopicByConsumerAck() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            rabbitMQService.sendMessageByExchange("sales_exchange", routingKey, "主题模式-测试消费端的ack，路由routingKey=" + routingKey + "  i=" + i);
        }
    }
}
